  ...
  <div id="global-layout">
    ...
    <div class="stream-container" @click="isMobileHeaderOpen = false">
      ...
      <div class="post-list-container post-list-container-shadow" v-else>
        <div class="post">
          <div
            :class="$page.frontmatter.featured_image ? 'post-head-wrapper' : 'post-head-wrapper-text-only'"
          ...
          >
            <div class="post-title">
              ...
              <div class="post-meta">
                ...
                >{{ $page.frontmatter.date.match(/\d{4}-\d{2}-\d{2}/)[0] }}</time>
  ...
  computed: {
    ...
    $title() {
      return this.$page.title
        ? this.$page.title + ' - ' + this.$site.title
        : this.$site.title;
    },
...
@import 'https://fonts.googleapis.com/css?family=Montserrat|Material+Icons|Noto+Serif+SC:400,700&display=swap';
</style>
